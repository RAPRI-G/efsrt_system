...
class RolesHelper {
    ...
    private static $permisosPorRol = [
        'administrador' => [
            'Inicio', 'Usuario', 'Empresa', 'Estudiante', 
            'Modulos', 'Practica', 'Asistencia', 'Reportes', 'Buscar'
        ],
        'docente' => [
            'Inicio', 'Estudiante', 'Asistencia', 'Reportes', 'Buscar'
        ],
        'estudiante' => [
            'Inicio', 'Practica', 'Asistencia'
        ]
    ];
    
    // Permisos por módulo para el menú
    private static $menuPermisos = [
        'inicio' => ['administrador', 'docente', 'estudiante'],
